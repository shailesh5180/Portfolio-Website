...
[![GitHub license](https://img.shields.io/github/license/shailesh5180/Portfolio?style=flat-square)](LICENSE)
...
```bash
git clone https://github.com/shailesh5180/Portfolio-Website
```
